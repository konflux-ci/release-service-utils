...
import managed_publish_index_image
from managed_publish_index_image import (
    _create_ir_wrapper,
    format_seconds,
    make_parser,
    main,
                ...
                "components": [
                    {
                        ...
                        "target_index_with_timestamp": "quay.io/test/index:v1.0-20240601120000",
                        "index_image": "quay.io/test/source:latest",
                        "index_image_resolved": "quay.io/test/source@sha256:abc123",
                        "ocp_version": "4.12",
                    },
                    {
                        "target_index": "quay.io/test/index:v1.1",
                        "target_index_with_timestamp": "quay.io/test/index:v1.1-20240601120500",
                        "index_image": "quay.io/test/source:latest2",
                        "index_image_resolved": "quay.io/test/source@sha256:def456",
                        "ocp_version": "4.13",
                    },
                ]
            }
...
class TestMainEdgeCases:
    ...
    def results_file_with_timestamp(self, tmp_path):
        """Create results file where target already includes timestamp (pre-ga/hotfix case)."""
            ...
            json.dumps(
                {
                    "components": [
                        {
                            "target_index": "quay.io/test/index:v1.0-20240601120000",
                            "target_index_with_timestamp": "quay.io/test/index:v1.0-20240601120000",
                            "index_image": "quay.io/test/source:latest",
                            "index_image_resolved": "quay.io/test/source@sha256:abc123",
                            "ocp_version": "4.12",
