...
class TestRun:
    ...
    @patch("push_disk_images.internal_request")
...
class TestMain:
    ...
    def test_dunder_main_block(
        ...
        with (
            patch("internal_request.create", return_value="ir"),
            patch(
                "internal_request.fetch_results",
            ...
            runpy.run_module("push_disk_images", run_name="__main__")
