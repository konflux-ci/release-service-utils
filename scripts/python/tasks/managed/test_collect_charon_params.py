...
class TestCollectCharonParams:
    ...
    def test_happy_path_all_fields(self) -> None:
        ...
        params = collect_charon_params.collect_charon_params(data, snapshot, release)
    ...
    def test_default_package_type(self) -> None:
        ...
        data = _default_data()
        params = collect_charon_params.collect_charon_params(
            data, _default_snapshot(), _default_release()
        )
        assert params.target == "dev-maven-ga"
    ...
    def test_no_components(self) -> None:
        ...
        snapshot = {"components": []}
        params = collect_charon_params.collect_charon_params(
            _default_data(), snapshot, _default_release()
        )
    ...
    def test_missing_environment(self) -> None:
        ...
        with pytest.raises(KeyError, match="environment"):
            collect_charon_params.collect_charon_params(
                data, _default_snapshot(), _default_release()
            )
...
class TestParseArgs:
    ...
    def test_all_args(self) -> None:
        ...
        args = collect_charon_params._parse_args(
            [
                "--work-dir",
                "/work",
                "--data-json-path",
    ...
    def test_missing_required_arg(self) -> None:
        ...
        with pytest.raises(SystemExit):
            collect_charon_params._parse_args([])
