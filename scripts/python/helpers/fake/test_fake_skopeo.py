...
def test_fake_client_requires_env_var() -> None:
...
def test_fake_client_requires_valid_file() -> None:
...
def test_inspect_with_format() -> None:
...
def test_inspect_without_format() -> None:
...
def test_inspect_regex_match() -> None:
...
def test_inspect_no_match() -> None:
...
def test_copy_explicit_success() -> None:
...
def test_validation_inspect_format_mismatch() -> None:
