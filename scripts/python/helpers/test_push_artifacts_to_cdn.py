...
# Load the wrapper by file path to avoid a name collision: both
# tasks/internal/push_artifacts_to_cdn.py and helpers/ share the name
# "push_artifacts_to_cdn", so a plain import would find the wrong one.
_WRAPPER_PATH = (
    Path(__file__).parent.parent / "tasks" / "internal" / "push_artifacts_to_cdn.py"
)
