...
FROM registry.redhat.io/rhtas/cosign-rhel9:1.4.0-1774865634 as cosign

FROM registry.redhat.io/advanced-cluster-security/rhacs-roxctl-rhel8:4.10.2-1 as roxctl
