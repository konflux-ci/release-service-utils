...
def _run_with_mocked_fetch(
    ...
    with (
        mock.patch(
            "release_service_utils.tasks.internal.get_advisory_severity"
...
def test_module_main_guard_raises_system_exit(
    ...
    with mock.patch(
        "release_service_utils.tasks.internal.get_advisory_severity.get_advisory_severity"
...
def test_run_no_cves_raises(tmp_path: Path) -> None:
    ...
    with (
        mock.patch(
            ...
            + ".get_advisory_severity.get_advisory_severity.authentication.kinit_with_retry",
            side_effect=_no_kinit,
        ),
        mock.patch(
            "release_service_utils.tasks.internal"
