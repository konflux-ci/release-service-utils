...
def test_is_build_newer_than_index_newer() -> None:
    ...
    with mock.patch(
        "update_fbc_catalog.update_fbc_catalog.inspect_image_created",
        side_effect=[
...
def test_check_previous_build_finds_fresh_complete() -> None:
    ...
    with (
        ...
        mock.patch(
            "update_fbc_catalog.update_fbc_catalog.is_build_newer_than_index",
            return_value=True,
        ),
    ):
...
def test_main_writes_iib_log_when_url_empty(
    ...
    with mock.patch("update_fbc_catalog.update_fbc_catalog.run", return_value=fake_result):
        rc = update_fbc_catalog.update_fbc_catalog.main(
...
def test_is_build_newer_catalog_date_unparseable() -> None:
    ...
    with (
        ...
        mock.patch(
            "update_fbc_catalog.update_fbc_catalog._is_build_newer_via_iib",
            return_value=True,
        ) as iib_mock,
    ):
        assert update_fbc_catalog.update_fbc_catalog.is_build_newer_than_index(
