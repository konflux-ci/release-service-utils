...
class TestCleanup:
    ...
    def test_successful_deletion(self) -> None:
        ...
        proc = _completed()
        with mock.patch(
            "cleanup_internal_requests.cleanup_internal_requests.subprocess.run",
            return_value=proc,
        ):
...
class TestRun:
    ...
    def test_skips_on_empty_uid(self) -> None:
        ...
        with mock.patch(
            "cleanup_internal_requests.cleanup_internal_requests.cleanup"
        ) as mock_cleanup:
...
class TestMain:
    ...
    def test_success(self) -> None:
        ...
        with mock.patch("cleanup_internal_requests.cleanup_internal_requests.run"):
    ...
    def test_empty_uid_is_valid(self) -> None:
        ...
        with mock.patch("cleanup_internal_requests.cleanup_internal_requests.run") as mock_run:
    ...
    def test_runtime_error_propagates(self) -> None:
        ...
        with mock.patch(
            "cleanup_internal_requests.cleanup_internal_requests.run",
