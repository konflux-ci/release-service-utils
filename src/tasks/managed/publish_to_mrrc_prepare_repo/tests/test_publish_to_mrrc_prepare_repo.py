...
from release_service_utils.tasks.managed import publish_to_mrrc_prepare_repo
...
def test_prepare_repo_downloads_into_short_hash_dirs(
    ...
    monkeypatch.setattr(
        publish_to_mrrc_prepare_repo.publish_to_mrrc_prepare_repo.oras_utils,
        "oras_pull",
        fake_oras_pull,
    )
...
def test_main_success(tmp_path: Path, monkeypatch: pytest.MonkeyPatch) -> None:
    ...
    monkeypatch.setattr(
        publish_to_mrrc_prepare_repo.publish_to_mrrc_prepare_repo,
        "prepare_repo",
        lambda **_: None,
    )
