...
from release_service_utils.helpers import file as file_helpers
...
def run(
    ...
    snapshot = file_helpers.load_json_dict(snapshot_file)
    data = file_helpers.load_json_dict(data_file)
