...
from release_service_utils.tasks.managed.push_artifacts_to_storage import (
    push_artifacts_to_storage,
)
import pytest

TASK = (
    "release_service_utils.tasks.managed"
    ".push_artifacts_to_storage.push_artifacts_to_storage"
)
...
@patch(f"{TASK}.oras_utils.oras_pull")
def test_happy_path(
