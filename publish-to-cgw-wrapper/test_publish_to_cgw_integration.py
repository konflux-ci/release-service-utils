...
def metadata():
    ...
    return [
        {
            **base,
            "shortURL": "/product_code_1/1.1/sha256sum.txt",
        ...
        {
            **base,
            "shortURL": "/product_code_1/1.1/sha256sum.txt.gpg",
        ...
        {
            **base,
            "shortURL": "/product_code_1/1.1/sha256sum.txt.sig",
        ...
        {
            **base,
            "shortURL": "/product_code_1/1.1/cosign",
        ...
        {
            **base,
            "shortURL": "/product_code_1/1.1/cosign-linux-amd64.gz",
        ...
        {
            **base,
            "shortURL": "/product_code_1/1.1/cosign-darwin-amd64.gz",
